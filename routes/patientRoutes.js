...
const { patient_login, set_appointment, edit_Details, get_Doctors, personal_MedicalHistory, show_Appointment } = require('../controllers/PatientControllers');
...
patientroute.get("/showAppointment/patient", requirePatientAuth, show_Appointment);
